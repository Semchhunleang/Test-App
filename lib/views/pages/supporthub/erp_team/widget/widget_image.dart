...
class BuildWidgetERPSupportHubImage extends StatelessWidget {
  ...
  bool canInsertPic() => (data == null || data?.state == waiting);
  bool showApiPic() =>
      (data != null && (data!.images.isNotEmpty || data!.files.isNotEmpty));

  Widget buildImageApi() => Consumer<RequestContactFormViewModel>(
              ...
              child: InkWell(
                  ...
                  child: Row(children: [
                    ...
                    IconButton(
                        ...
                        onPressed: () =>
                            Provider.of<RequestContactFormViewModel>(context,
                                    listen: false)
                                .onRemoveFile(i))
                  ])))),
          ...
          itemBuilder: (context, i) => GestureDetector(
              ...
              child: Stack(alignment: Alignment.topRight, children: [
                ...
                IconButton(
                    icon: const Icon(Icons.delete_forever_rounded,
                        size: 20, color: Colors.red),
                    onPressed: () => Provider.of<RequestContactFormViewModel>(
                            context,
                            listen: false)
                        .onRemoveImage(i))
              ])))
