...
import 'package:umgkh_mobile/views/pages/hr/approve_leave/widget/leave_status_indicator.dart';
import 'package:umgkh_mobile/views/pages/hr/take_leave/form.dart';

Widget approveLeaveCard({required BuildContext context, required Leave leave}) {
  return GestureDetector(
    onTap: () {
      navPush(context, TakeLeaveFormPage(leave: leave));
      // showApproveLeaveDetailsDialog(context, leave, leave.state);
    },
    child: Card(
      child: Row(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                approveLeaveStatusIndicator(leave: leave),
              ],
            ),
          ),
          Expanded(
