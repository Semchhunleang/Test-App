...
import 'package:umgkh_mobile/views/pages/service/workshop/info.dart';

class ItemWorkshopWidget extends StatelessWidget {
  final ProjectTask data;
  const ItemWorkshopWidget({super.key, required this.data});
