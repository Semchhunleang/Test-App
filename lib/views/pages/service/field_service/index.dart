...
import 'package:umgkh_mobile/views/pages/service/field_service/widget/item_field_service.dart';
...
class FieldServicePage extends StatefulWidget {
  static const routeName = '/field-service';
  static const pageName = 'Field  Service';
...
class _FieldServicePageState extends State<FieldServicePage> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      p1.resetData('field_service');
      p1.fetchData('field_service');
      p2.fetchDispatchFrom();
      p2.fetchArriveAt();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) => Consumer<FieldServiceViewModel>(
        builder: (context, viewModel, _) => CustomScaffold(
          title: FieldServicePage.pageName,
          body: Column(
            children: [
              Card(
                elevation: 0,
              ...
              ListCondition(
                ...
                onRefresh: () => viewModel.fetchData('field_service'),
