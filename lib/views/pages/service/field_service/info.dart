...
import 'package:umgkh_mobile/views/pages/service/field_service/widget/build_item_info.dart';
import 'package:umgkh_mobile/views/pages/service/field_service/widget/build_lines.dart';
import 'package:umgkh_mobile/widgets/custom_scaffold.dart';

class FieldServiceInfoPage extends StatefulWidget {
  const FieldServiceInfoPage({
    super.key,
  });

  @override
  State<FieldServiceInfoPage> createState() => _FieldServiceInfoPageState();
}

class _FieldServiceInfoPageState extends State<FieldServiceInfoPage> {
  @override
  void initState() {
